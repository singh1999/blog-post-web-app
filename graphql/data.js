export const blogPosts = [
  ...
  },
  {
    ...
    "content": "Brooklyn’s coffee scene is thriving, with new spots popping up every month. From industrial-style cafes with pour-over perfection to cozy nooks serving homemade pastries, the borough has something for everyone. Whether you’re a freelancer looking for strong Wi-Fi and stronger espresso or just want a quiet place to read, this list curates the best spots that locals truly love and return to.",
    "author": "Alex Kwon",
  ...
  },
  {
    ...
    "content": "Minimalism isn’t just about decluttering your space; it’s a mindset that encourages intentional living. By choosing fewer, higher-quality items and eliminating excess, you create a calm, focused environment. Minimalist decor enhances mental clarity, reduces decision fatigue, and promotes sustainability. It’s about making room—physically and mentally—for what truly matters.",
    "author": "Lina Desai",
  ...
  },
  {
    ...
    "content": "Reading 52 books in a year might sound like an impossible challenge, but with the right mindset and strategies, it becomes doable. I created a consistent reading habit, replaced screen time with audiobooks, and stopped finishing books that didn’t resonate. The goal wasn’t quantity—it was rediscovering the joy of learning through stories and ideas.",
  ...
  },
  {
    ...
    "author": "Rahul Singh",
    "content": "Check out my new blog post that i am just about to post :) Check out my new blog post that i am just about to post :)Check out my new blog post that i am just about to post :)Check out my new blog post that i am just about to post :)Check out my new blog post that i am just about to post :)Check out my new blog post that i am just about to post :)",
    "createdAt": "11-04-2025. 02:14"
  }
];